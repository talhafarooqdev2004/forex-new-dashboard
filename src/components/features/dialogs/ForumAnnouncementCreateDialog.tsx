...
import useForumAnnouncementStoreForm, { type ForumAnnouncementFormValues } from "@/hooks/forms/forum/useForumAnnouncementStoreForm";
import type { ForumAnnouncement } from "@/types";

type ForumAnnouncementDialogMode = "create" | "edit";

type ForumAnnouncementCreateDialogProps = {
    open: boolean;
    mode: ForumAnnouncementDialogMode;
    announcement?: ForumAnnouncement | null;
    onOpenChange: (open: boolean) => void;
    onSubmitAnnouncement: (data: ForumAnnouncementFormValues) => Promise<void>;
};

export default function ForumAnnouncementCreateDialog({
    open,
    mode,
    announcement,
    onOpenChange,
    onSubmitAnnouncement,
}: ForumAnnouncementCreateDialogProps) {
    return (
...
function ForumAnnouncementForm({
    mode,
    announcement,
    setClose,
    onSubmitAnnouncement,
...
function TranslationTagsField({
    ...
    control: Control<ForumAnnouncementFormValues>;
    localeIndex: number;
    localeLabel: string;
}) {
