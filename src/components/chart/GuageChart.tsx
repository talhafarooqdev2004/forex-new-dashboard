...
type GuageChartProps = {
    ...
    /** Extra vertical offset for corner Sell/Buy labels (SVG `dy`, default 0). */
    customLabelDy?: number;
    customLeftLabelTextAnchor?: "start" | "middle" | "end";
    customRightLabelTextAnchor?: "start" | "middle" | "end";
    /** Font size for custom corner labels (default 8.5). */
    customLabelFontSize?: number;
    /** Font size for center “Neutral” arc label (default 8). */
    neutralLabelFontSize?: number;
    /** Vertical offset for “Neutral” (SVG dy, default 0). */
    neutralLabelDy?: number;
...
export default function GuageChart({
    ...
    customLabelY = 95,
    customLabelDy = 0,
    customLeftLabelTextAnchor = "start",
    customRightLabelTextAnchor = "end",
    customLabelFontSize = 8.5,
    neutralLabelFontSize = 8,
    neutralLabelDy = 0,
    hideArcLabels = false,
                        ...
                        */}
                            {customLeftLabel && (
                                <text
                                    ...
                                    fontWeight="700"
                                    fill="currentColor"
                                    textAnchor={customLeftLabelTextAnchor}
                            ...
                            {customRightLabel && (
                                <text
                                    ...
                                    fontWeight="700"
                                    fill="currentColor"
                                    textAnchor={customRightLabelTextAnchor}
                                    dominantBaseline="auto"
                                    fontFamily="'Montserrat', 'Roboto', 'Open Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Helvetica Neue', Arial, sans-serif"
                                    letterSpacing="1px"
                                >
