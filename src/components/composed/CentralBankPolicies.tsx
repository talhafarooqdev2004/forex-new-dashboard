    ...
    return (
        <div className="overflow-x-auto">
            <table className="mt-8 w-full border-collapse">
                <thead>
                    <tr className="text-sm whitespace-nowrap border-b-2 border-solid border-stroke">
                        <th className="pb-2">Bank</th>
                        <th className="pb-2">Current rate</th>
                        <th role="button" className="flex items-center gap-2 pb-2">
                            <span>Policy</span>
...
function CentralBankPolicy({ bank, currentRate, policy, lastUpdated }: { bank: string, currentRate: string, policy: string, lastUpdated: string }) {
    return (
        <tr className="border-b-2 border-solid border-stroke text-sm">
            ...
            <td className="min-w-[120px] lg:min-w-[160px] xl:min-w-[200px] align-top ">
