    ...
    return (
        <div className="rounded-[12px] w-full min-w-0 overflow-hidden">
            <div className="w-full min-w-0 horizontal-scroll">
                <div className="relative bg-[#1a1d23] h-[370px] min-w-[450px] overflow-clip rounded-[12px]">
            {/* Y-axis labels */}
            ...
            <p className="absolute font-['Inter',sans-serif] font-bold leading-[24px] left-[282px] text-[20px] text-white top-[263px]">
                Apr
            </p>
            <p className="absolute font-['Inter',sans-serif] font-bold leading-[24px] left-[349px] text-[20px] text-white top-[263px]">
                May
            </p>
            ...
            <p className="absolute font-['Inter',sans-serif] font-normal leading-[22px] left-[203px] text-[16px] text-white top-[305px] tracking-[-0.18px]">
                Paid
            </p>
                </div>
            </div>
