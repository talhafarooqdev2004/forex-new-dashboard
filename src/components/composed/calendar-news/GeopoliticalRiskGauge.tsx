...
/** The old custom path's local tip angle. */
...
/**
 * Thick 4-bar semicircle with labels inside the bars + theme-aware legacy needle.
 * Needle snaps to the fixed rotations used by the previous Daily Market View.
 */
